...
window.onload=function(){
    ...
    window.setTimeout(function(){
        ...
        $('img1').src = './static/code/displaygen_pic/1.png?t='+ Math.random();
        $('img2').src = './static/code/display/bird_0.png?t='+ Math.random();
        $('img3').src = './static/code/display/bird_1.png?t='+ Math.random();
        $('img4').src = './static/code/displaygen_pic/0.png?t='+ Math.random();
        $('img5').src = './static/code/displaygen_pic/1.png?t='+ Math.random();
        $('img6').src = './static/code/display/bird_0.png?t='+ Math.random();
    },30000);
}
